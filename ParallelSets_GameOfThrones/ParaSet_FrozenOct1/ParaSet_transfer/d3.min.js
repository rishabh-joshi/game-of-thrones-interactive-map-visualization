!function() {
    ...
    function m(n) {
        function t() {
            for (var t, e = r, u =- 1, i = e.length; ++u < i;)(t = e[u].on) 
    ...
    function P(n, t) {
        for (var r = 0, e = n.length; e > r; r++)
            for (var u, i = n[r], o = 0, a = i.length; a > o; o++)(u = i[o]) 
                && t(u, o, r);
        return n
    }
    function U(n) {
    ...
    function Tt() {
        var n = Date.now();
        for (lc = ic; lc;)
            n >= lc.t && (lc.f = lc.c(n - lc.t)), lc = lc.n;
        return n
    }
    function zt() {
        for (var n, t = ic, r = 1 / 0; t;)
            t.f ? t = n ? n.n = t.n : ic = t.n : (t.t < r && (r = t.t), t = (n = t).n);
        return oc = n, r
    }
    function Rt(n, t) {
        ...
        function t(n) {
            function t(t) {
                for (var r, u, i, o = [], a =- 1, c = 0; ++a < e;)
                    37 === n.charCodeAt(a) && (o.push(n.substring(c, a)), null != (u = mc[r = n.charAt(++a)]) && (r = n.charAt(++a)), (i = A[r]) && (r = i(t, null == u ? "e" === r ? " " : "0" : u)), o.push(r), c = a + 1);
        ...
        function r(n, t, r, e) {
            for (var u, i, o, a = 0, c = t.length, l = r.length; c > a;) {
                ...
                if (u = t.charCodeAt(a++), 37 === u) {
                    if (o = t.charAt(a++), i = C[o in mc ? t.charAt(a++): o], !i || (e = i(n, r, e)) < 0)
                        return - 1
    ...
    function Fr(n, t, r, e) {
        var u;
        if (null == n)
            u = r * Ha, e.point( - Ua, u), e.point(0, u), e.point(Ua - Fa, u), e.point(Ua - Fa, 0), e.point(Ua - Fa, - u), e.point(0, - u), e.point( - Ua, - u), e.point( - Ua, 0), e.point( - Ua, u);
        ...
        function r(n) {
            ...
            return {
                ...
                point: function(f, h) {
                    ...
                    if (!r && (l = c = v) && n.lineStart(), v !== c && (g = e(r, p), (br(r, g) || br(p, g)) && (p[0] += Fa, p[1] += Fa, v = t(p[0], p[1]))), v !== c)
                        s = 0, v ? (n.lineStart(), g = e(p, r), n.point(g[0], g[1])) : (g = e(r, p), n.point(g[0], g[1]), n.lineEnd()), r = g;
                    else if (a && r && o^v) {
                        var m;
            ...
            function c(n) {
                for (var t = 0, r = d.length, e = n[1], u = 0; r > u; ++u)
                    for (var i, o = 1, a = d[u], c = a.length, l = a[0]; c > o; ++o)
                        i = a[o], l[1] <= e ? i[1] > e && J(l, i, n) > 0&&++t : i[1] <= e && J(l, i, n) < 0&&--t, l = i;
                return 0 !== t
            }
            function l(i, a, c, l) {
                var s = 0, f = 0;
    ...
    function Xe(n) {
        ...
        if (al.insert(t, c), t || r) {
            if (t === r)
                return tu(t), r = Ze(t.site), al.insert(c, r), c.edge = r.edge = iu(t.site, c.site), nu(t), nu(r), void 0;
            if (!r)
                return c.edge = iu(t.site, c.site), void 0;
            tu(t), tu(r);
        ...
        for (var t, r, e, u, i, o, a, c, l, s, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = ol, d = v.length; d--;)
            if (i = v[d], i && i.prepare())
                for (a = i.edges, c = a.length, o = 0; c > o;)
                    s = a[o].end(), e = s.x, u = s.y, l = a[++o%c].start(), t = l.x, r = l.y, (Ma(e - t) > Fa || Ma(u - r) > Fa) && (a.splice(o, 0, new cu(ou(i.site, s, Ma(e - f) < Fa && p - u > Fa ? {
                        x: f,
                        y: Ma(t - f) < Fa ? r: p
                    } : Ma(u - p) < Fa && h - e > Fa ? {
                        x: Ma(r - p) < Fa ? t: h,
    ...
    function ru(n) {
        for (var t, r = il, e = Yr(n[0][0], n[0][1], n[1][0], n[1][1]), u = r.length; u--;)
            t = r[u], (!eu(t, n) ||!e(t) || Ma(t.a.x - t.b.x) < Fa && Ma(t.a.y - t.b.y) < Fa) && (t.a = t.b = null, r.splice(u, 1))
    }
    function eu(n, t) {
        var r = n.b;
        if (r)
    ...
    function Su(n, t) {
        ...
        for (n += "", t += "", gl.lastIndex = 0, e = 0; r = gl.exec(t); ++e)
            r.index && l.push(t.substring(a, c = r.index)), s.push({
                i: l.length,
                x: r[0]
            }), l.push(null), a = gl.lastIndex;
        for (a < t.length && l.push(t.substring(a)), e = 0, i = s.length; (r = gl.exec(n)) && i > e; ++e)
            if (o = s[e], o.x == r[0]) {
                if (o.i)
                    if (null == l[o.i + 1])
                        for (l[o.i - 1] += o.x, l.splice(o.i, 1)
                            , u = e + 1;
                            i > u;
                            ++u)s[u].i--;
                    else 
                        for (l[o.i - 1] += o.x + l[o.i + 1], l.splice(o.i, 2)
                            , u = e + 1;
                            i > u;
                            ++u)s[u].i -= 2;
                ...
                for (l[o.i] = o.x + l[o.i + 1], l.splice(o.i + 1, 1)
                    , u = e + 1;
                    i > u;
                    ++u)s[u].i--;
                    s.splice(e, 1), i--, e--
    ...
    function ui(n, t, r) {
        ...
        if (n.charge = 0, !n.leaf)
            for (var i, o = n.nodes, a = o.length, c =- 1; ++c < a;)
                i = o[c], null != i && (ui(i, t, r), n.charge += i.charge, e += i.charge * i.cx, u += i.charge * i.cy);
        if (n.point) {
    ...
    function vi(n) {
        for (var t, r = 1, e = 0, u = n[0][1], i = n.length; i > r; ++r)(t = n[r][1]) 
            > u && (e = r, u = t);
        return e
    }
    function di(n) {
    ...
    function Ci(n) {
        for (var t, r = 0, e = 0, u = n.children, i = u.length; --i >= 0;)
            t = u[i]._tree, t.prelim += r, t.mod += r, r += t.shift + (e += t.change)
    }
    function Li(n, t, r) {
        n = n._tree, t = t._tree;
    ...
    function Co(n, t) {
        ...
        if (r && (e += "Q" + (i[0] - 2 * o[0] / 3) + "," + (i[1] - 2 * o[1] / 3) + "," + i[0] + "," + i[1], u = n[1], c = 2), t.length > 1) {
            ...
            for (var l = 2; l < t.length; l++, c++)
                i = n[c], a = t[l], e += "S" + (i[0] - a[0]) + "," + (i[1] - a[1]) + "," + i[0] + "," + i[1]
        }
        if (r) {
            var s = n[c];
    ...
    function Lo(n, t) {
        for (var r, e = [], u = (1 - t) / 2, i = n[0], o = n[1], a = 1, c = n.length; ++a < c;)
            r = i, i = o, o = n[a], e.push([u * (o[0] - r[0]), u * (o[1] - r[1])]);
        return e
    }
    function qo(n) {
        if (n.length < 3)
    ...
    function zo(n) {
        ...
        for (t = [Do(Ul, o), ",", Do(Ul, a)], --e; ++e < i;)
            r = n[e%u], o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), Po(t, o, a);
        return t.join("")
    }
    function Ro(n, t) {
        var r = n.length - 1;
        if (r)
            for (var e, u, i = n[0][0], o = n[0][1], a = n[r][0] - i, c = n[r][1] - o, l =- 1; ++l <= r;)
                e = n[l], u = l / r, e[0] = t * e[0] + (1 - t) * (i + u * a), e[1] = t * e[1] + (1 - t) * (o + u * c);
        return qo(n)
    }
    function Do(n, t) {
    ...
    function Ho(n) {
        for (var t, r, e, u, i = [], o = jo(n), a =- 1, c = n.length - 1; ++a < c;)
            t = Uo(n[a], n[a + 1]), Ma(t) < Fa ? o[a] = o[a + 1] = 0 : (r = o[a] / t, e = o[a + 1] / t, u = r * r + e * e, u > 9 && (u = 3 * t / Math.sqrt(u), o[a] = u * r, o[a + 1] = u * e));
        for (a =- 1; ++a <= c;)
    ...
    function Oo(n) {
        for (var t, r, e, u =- 1, i = n.length; ++u < i;)
            t = n[u], r = t[0], e = t[1] + Tl, t[0] = r * Math.cos(e), t[1] = r * Math.sin(e);
        return n
    }
    function Io(n) {
        function t(t) {
    ...
    function ra(n, t, r) {
        ...
        return e.invert = function(t) {
            ...
            var r = Xi(e.domain()), i = null == n ? u(r, 10): "number" == typeof n ? u(r, n): !n.range && [{
                range: n
            }, t];
    ...
    oa.nest = function() {
        function n(t, a, c) {
            ...
            for (var l, s, f, h, g =- 1, p = a.length, v = i[c++], d = new o; ++g < p;)(h = d.get(l = v(s = a[g]))
                ) ? h.push(s) : d.set(l, [s]);
    ...
    La.select = function(n) {
        ...
        for (var o =- 1, a = this.length; ++o < a;) {
            ...
            for (var c =- 1, l = e.length; ++c < l;)(u = e[c]) 
                ? (t.push(r = n.call(u, u.__data__, c, o)), r && "__data__"in u && (r.__data__ = u.__data__)) : t.push(null)
        }
        return _(i)
        ...
        for (var u =- 1, i = this.length; ++u < i;)
            for (var o = this[u], a =- 1, c = o.length; ++a < c;)(r = o[a]) 
    ...
    oa.ns = {
        ...
        function r(n, r) {
            ...
            if (t) {
                ...
                for (e =- 1; ++e < f;)
                    d = t.call(r, i = r[e], e), (u = m.get(d)) ? (g[e] = u, u.__data__ = i) : y.has(d) || (p[e] = z(i)), y.set(d, i), m.remove(d);
                for (e =- 1; ++e < a;)
                    m.has(x[e]) && (v[e] = n[e])
            } else {
                for (e =- 1; ++e < h;)
                    u = n[e], i = r[e], u ? (u.__data__ = i, g[e] = u) : p[e] = z(i);
                for (; f > e; ++e)
                    p[e] = z(r[e]);
                for (; a > e; ++e)
                    v[e] = n[e]
        ...
        if (!arguments.length) {
            for (n = new Array(a = (e = this[0]).length); ++i < a;)(u = e[i]) 
                && (n[i] = u.__data__);
            return n
        }
        var c = U([]), l = _([]), s = _([]);
        ...
        for (var i = 0, o = this.length; o > i; i++) {
            ...
            for (var a = 0, c = r.length; c > a; a++)(e = r[a]) 
                && n.call(e, e.__data__, a, i) && t.push(e)
        }
        return _(u)
    }, La.order = function() {
        for (var n =- 1, t = this.length; ++n < t;)
            for (var r, e = this[n], u = e.length - 1, i = e[u]; --u >= 0;)(r = e[u]) 
                && (i && i !== r.nextSibling && i.parentNode.insertBefore(r, i), i = r);
        return this
    }, La.sort = function(n) {
    ...
    oa.selection.enter = U, oa.selection.enter.prototype = Ta, Ta.append = La.append, Ta.empty = La.empty, Ta.node = La.node, Ta.call = La.call, Ta.size = La.size, Ta.select = function(n) {
        for (var t, r, e, u, i, o = [], a =- 1, c = this.length; ++a < c;) {
            ...
            for (var l =- 1, s = u.length; ++l < s;)(i = u[l]) 
                ? (t.push(e[l] = r = n.call(u.parentNode, i.__data__, l, a)), r.__data__ = i.__data__) : t.push(null)
        }
        return _(o)
        ...
        for (var n, t, r = Hl||++Zl, e = [], u = Fl || {
            ...
            e.push(n = []);
            for (var a = this[i], c =- 1, l = a.length; ++c < l;)(t = a[c]) 
                && Ko(t, c, r, u), n.push(t)
        }
        return Jo(e, r)
        ...
        return function(n) {
            ...
            if (t) {
                ...
                for (var r, e = 1, u = x[0], i = [u]; t > e; ++e)
                    r = x[e], l(r[0], u) || l(r[1], u) ? (a(u[0], r[1]) > a(u[0], u[1]) && (u[1] = r[1]), a(r[0], u[1]) > a(u[0], u[1]) && (u[0] = r[0])) : i.push(u = r);
                for (var o, r, p =- 1 / 0, t = i.length - 1, e = 0, u = i[t]; t >= e; u = r, ++e)
                    r = i[e], (o = a(u[1], r[0])) > p && (p = o, s = r[0], h = u[1])
            }
    ...
    ul.area = function() {
        ...
        for (var t, r, e, u, i, o, a = Ie(n), c =- 1, l = this.length - Ie(this), s = this[l - 1]; ++c < l;) {
            for (t = n.slice(), n.length = 0, u = this[c], i = t[(e = t.length - a) - 1], r =- 1; ++r < e;)
                o = t[r], Fe(o, s, u) ? (Fe(i, s, u) || n.push(Oe(i, o, s, u)), n.push(o)) : Fe(i, s, u) && n.push(Oe(i, o, s, u)), i = o;
            a && n.push(n[0]), s = u
        }
        return n
    };
    ...
    We.prototype.prepare = function() {
        ...
        insert: function(n, t) {
            ...
            if (n) {
                ...
                this._ ? (n = gu(this._), t.P = null, t.N = n, n.P = n.L = t, r = n) : (t.P = t.N = null, this._ = t, r = null);
            for (t.L = t.R = null, t.U = r, t.C=!0, n = t; r && r.C;)
                e = r.U, r === e.L ? (u = e.R, u && u.C ? (r.C = u.C=!1, e.C=!0, n = e) : (n === r.R && (fu(this, r), n = r, r = n.U), r.C=!1, e.C=!0, hu(this, e))) : (u = e.L, u && u.C ? (r.C = u.C=!1, e.C=!0, n = e) : (n === r.L && (hu(this, r), n = r, r = n.U), r.C=!1, e.C=!0, fu(this, e))), r = n.U;
            this._.C=!1
        },
        remove: function(n) {
        ...
        return n ? t(n) : (t.links = function(n) {
            ...
            return pu(r(n)).cells.forEach(function(r, e) {
                for (var u, i, o = r.site, a = r.edges.sort(Ke), c =- 1, l = a.length, s = a[l - 1].edge, f = s.l === o ? s.r : s.l; ++c < l;)
                    u = s, i = f, s = a[c].edge, f = s.l === o ? s.r : s.l, e < i.i && e < f.i && du(o, i, f) < 0 && t.push([n[e], n[i.i], n[f.i]])
            }), t
        }, t.x = function(n) {
    ...
    oa.interpolateTransform = Bu, oa.layout = {}, oa.layout.bundle = function() {
        ...
        return a.tick = function() {
            ...
            for (r =- 1; ++r < _;)
                a = m[r], a.fixed ? (a.x = a.px, a.y = a.py) : (a.x -= (a.px - (a.px = a.x)) * s, a.y -= (a.py - (a.py = a.y)) * s);
            c.tick({
                type: "tick",
                alpha: e
            })
    ...
    oa.layout.hierarchy = function() {
        function n(t, o, a) {
            ...
            if (t.depth = o, a.push(t), c && (l = c.length)) {
                ...
                delete t.children, i && (t.value =+ i.call(r, t, o) || 0);
            return t
        }
        function t(n, e) {
    ...
    var bl = oa.map({
        "inside-out": function(n) {
            ...
            for (t = 0; e > t; ++t)
                r = o[t], c > a ? (a += i[r], l.push(r)) : (c += i[r], s.push(r));
    ...
    oa.layout.histogram = function() {
        function n(n, i) {
            ...
            if (g > 0)
                for (i =- 1; ++i < h;)
                    a = l[i], a >= s[0] && a <= s[1] && (o = c[oa.bisect(f, a, 1, g) - 1], o.y += p, o.push(n[i]));
            return c
        }
        ...
        function n(n, i) {
            ...
            function c(n, t, e) {
                if (t) {
                    for (var u, i = n, o = n, a = t, c = n.parent.children[0], l = i._tree.mod, s = o._tree.mod, f = a._tree.mod, h = c._tree.mod; a = wi(a), i = bi(i), a && i;)
                        c = bi(c), o = wi(o), o._tree.ancestor = n, u = a._tree.prelim + f - i._tree.prelim - l + r(a, i), u > 0 && (Li(qi(a, n, e), n, u), l += u, s += u), f += a._tree.mod, l += i._tree.mod, h += c._tree.mod, s += o._tree.mod;
        ...
        function t(r) {
            ...
            if (i && i.length) {
                ...
                for (n(h, l.dx * l.dy / r.value)
                    , s.area = 0;
                (c = h.length) > 0;
                )s.push(o = h[c - 1]), s.area += o.area, "squarify" !== g || (a = e(s, v)) <= p ? (h.pop(), p = a) : (s.area -= s.pop().area, u(s, v, l, !1), v = Math.min(l.dx, l.dy), s.length = s.area = 0, p = 1 / 0);
        ...
        function u(n, t, r, e) {
            ...
            if (t == r.dx) {
                for ((e || s > r.dy) && (s = r.dy); ++i < o;)
                    u = n[i], u.x = a, u.y = l, u.dy = s, a += u.dx = Math.min(r.x + r.dx - a, s ? c(u.area / s) : 0);
                u.z=!0, u.dx += r.x + r.dx - a, r.y += s, r.dy -= s
            } else {
                for ((e || s > r.dx) && (s = r.dx); ++i < o;)
                    u = n[i], u.x = a, u.y = l, u.dx = s, l += u.dy = Math.min(r.y + r.dy - l, s ? c(u.area / s) : 0);
    ...
    oa.svg.line.radial = function() {
        ...
        function n(n, u) {
            var i = t.call(this, n, u), o = r.call(this, n, u), a = (i.y + o.y) / 2, c = [i, {
                x: i.x,
                y: a
            }, {
                x: o.x,
    ...
    Yl.call = La.call, Yl.empty = La.empty, Yl.node = La.node, Yl.size = La.size, oa.transition = function(n) {
        ...
        for (var o =- 1, a = this.length; ++o < a;) {
            i.push(t = []);
            for (var c = this[o], l =- 1, s = c.length; ++l < s;)(e = c[l]) 
                && (r = n.call(e, e.__data__, l, o)) ? ("__data__"in e && (r.__data__ = e.__data__), Ko(r, l, u, e.__transition__[u]), t.push(r)) : t.push(null)
        }
        return Jo(i, u)
        ...
        for (var c =- 1, l = this.length; ++c < l;)
            for (var s = this[c], f =- 1, h = s.length; ++f < h;)
                if (e = s[f]) {
                    ...
                    for (var g =- 1, p = r.length; ++g < p;)(u = r[g]) 
                        && Ko(u, g, o, i), t.push(u)
                }
        return Jo(a, o)
        ...
        for (var i = 0, o = this.length; o > i; i++) {
            u.push(t = []);
            for (var r = this[i], a = 0, c = r.length; c > a; a++)(e = r[a]) 
                && n.call(e, e.__data__, a, i) && t.push(e)
        }
        return Jo(u, this.id)
        ...
        for (var n, t, r, e, u = this.id, i=++Zl, o = [], a = 0, c = this.length; c > a; a++) {
            o.push(n = []);
            for (var t = this[a], l = 0, s = t.length; s > l; l++)(r = t[l]) 
                && (e = Object.create(r.__transition__[u]), e.delay += e.duration, Ko(r, l, i, e)), n.push(r)
        }
        return Jo(o, i)
    ...
    oa.svg.brush = function() {
        ...
        function u() {
            ...
            if (oa.event.changedTouches ? q.on("touchmove.brush", v).on("touchend.brush", m) : q.on("mousemove.brush", v).on("mouseup.brush", m), S.interrupt().selectAll("*").interrupt(), A)
