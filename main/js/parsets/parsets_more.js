main = function(fields) {
    ...
    d3.csv("../../data/parsets/battles.csv", function(error, csv) {
...
fields = ["AttackerHouse", "DefenderHouse", "AttackerOutcome"];
main(fields, vis);

function testCheckbox(oCheckbox, fields)
{
    if (oCheckbox.checked == true)
        fields.push(oCheckbox.name);
    return fields;
}   
...
function rebuild() {
    ...
    oCheckBox_AttackerKing = oForm.elements["AttackerKing"];
    oCheckBox_DefenderKing = oForm.elements["DefenderKing"];
    oCheckBox_AttackerHouse = oForm.elements["AttackerHouse"];
    oCheckBox_DefenderHouse = oForm.elements["DefenderHouse"];
    oCheckBox_AttackerOutcome = oForm.elements["AttackerOutcome"];
    oCheckBox_BattleType = oForm.elements["BattleType"];
    oCheckBox_MajorDeath = oForm.elements["MajorDeath"];
    oCheckBox_MajorCapture = oForm.elements["MajorCapture"];
    oCheckBox_AttackerSize = oForm.elements["AttackerSize"];
    oCheckBox_DefenderSize = oForm.elements["DefenderSize"];
    ...
    fields = testCheckbox(oCheckBox_MajorCapture, fields)
    fields = testCheckbox(oCheckBox_AttackerSize, fields)
